...
export default async function Blog() {
    ...
    return (
        <div className="container mx-auto py-8">
            <div className="bg-gradient-to-r from-black-800 to-green-600 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {data && data.length >= 1 ? (
                    data.map((post, index) => (
