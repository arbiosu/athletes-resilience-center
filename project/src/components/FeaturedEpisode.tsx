    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="py-4 space-y-4">
          <h3 className="text-2xl font-semibold">{featuredEpisode.name}</h3>
          <p className="">{featuredEpisode.description}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="flex items-center space-x-4 text-sm">
            <span className="font-semibold">Length: {new Date(episode.duration_ms).toISOString().substr(11, 8)}</span>
            <span className="font-semibold">|</span>
            <span className="font-semibold">Released on: {new Date(episode.release_date).toLocaleDateString()}</span>
          </div>
          <div className="py-4">
