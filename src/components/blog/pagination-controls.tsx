  ...
  return (
    <div className='flex flex-wrap items-center justify-center gap-2 py-4'>
      <button
        ...
        className='border-foreground rounded-3xl border px-2 text-sm transition-opacity disabled:cursor-not-allowed disabled:opacity-50 sm:px-4 sm:text-base'
      ...
      {pageNumbersToDisplay.map((page, index) =>
        page === -1 ? (
          ...
          <button
            ...
            className={`border-foreground rounded-3xl border px-2 text-sm transition-opacity sm:px-4 sm:text-base ${
              optimisticPage === page
